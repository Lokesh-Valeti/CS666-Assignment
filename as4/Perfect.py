...
print("Realibility is:",reliabilityOfPUF(rel_add))
...
print("The Uniformity for Board1 is ",board1_uniformity)
...
print("The Uniformity for Board2 is ",board2_uniformity)
...
print("The Uniformity for Board3 is ",board3_uniformity)
